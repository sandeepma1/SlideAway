...
public class GPG_CloudSaveSystem
{
    ...
    //This is the saved file. Put this in seperate class with other variables for more advanced setup.
    //Remember to change merging, toBytes and fromBytes for more advanced setup.
